...
GPIO Configuration:
- HAL_GPIO_1 Direction: P9.11 (GPIO30, output)
- HAL_GPIO_2 Direction: P9.26 (GPIO14, output)

- HAL_GPIO_3 Tachometer: P8.14 (GPIO26, input, rising edge)
- HAL_GPIO_4 Tachometer: P8.12 (GPIO44, input, rising edge)
