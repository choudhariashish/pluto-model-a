#!/bin/bash
# Remote installation script for bbb-pwm-demo on BeagleBone Black
...
PASSWORD=$2
IP_ADDRESS=$3
BINARY_NAME="bbb-pwm-demo"
BINARY_INSTALL_PATH="/usr/local/bin"

echo "=== BBB PWM Demo Remote Installation ==="
...
cd "$WORKSPACE_ROOT"
bazel build //labs/bbb-pwm-demo:bbb-pwm-demo --config=bbb
...
BINARY_PATH="$WORKSPACE_ROOT/bazel-bin/labs/bbb-pwm-demo/bbb-pwm-demo"
...
echo "  $BINARY_NAME 1 50    # Set PWM1 (P9.14) to 50% duty"
echo "  $BINARY_NAME 3 0     # Disable PWM3 (P9.21)"
echo ""
